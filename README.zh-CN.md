...
- 后续扩展 Node.js、Rust、Go、Java、npm、pnpm、yarn 等更多工具链。
- 支持浅色、深色和跟随系统主题。
...
应用中已经包含 PHP、Nginx、MySQL、Composer、服务控制、配置编辑、虚拟主机和设置等页面，但它还不是一个完全稳定的正式版本。部分能力可能仍然以 macOS 为主，跨平台支持和发布流程也还在继续完善。
...
- 改进跨平台运行时和工具链支持。
- 支持 Node.js、Rust、Go、Java、npm、pnpm、yarn 以及相关工具。
- 完善发布打包和更新流程。
